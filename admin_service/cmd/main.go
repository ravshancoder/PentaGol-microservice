...
import (
	...
	"github.com/PentaGol/admin_service/pkg/db"
	"github.com/PentaGol/admin_service/pkg/logger"
	"github.com/PentaGol/admin_service/service"
...
func main() {
	...
	adminService := service.NewAdminService(connDb, log, grpcClient)

	lis, err := net.Listen("tcp", cfg.AdminServicePort)
	if err != nil {
	...
	u.RegisterAdminServiceServer(s, adminService)

	log.Info("main: server running",
		logger.String("port", cfg.AdminServicePort))
